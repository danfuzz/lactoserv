...
export async function usualFetch(options) {
  ...
  // request (e.g. see above), making it arguably a bad choice for these tests
  // which all ideally exert careful control over what's actually sent. TODO:
  // Replace this with something different (though, for ease, perhaps with a
  // compatible API).
