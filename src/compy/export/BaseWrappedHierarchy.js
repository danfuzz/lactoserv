...
/**
 * Base component class which manages a "wrapped" component hierarchy, that is,
...
export class BaseWrappedHierarchy extends BaseComponent {
   ...
   * its return value, ready for a call to {@link #restart}.
   */
   ...
   * successful call to {@link #prepareToRestart}.
   */
  async restart() {
