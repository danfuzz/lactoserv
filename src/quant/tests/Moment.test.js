...
`('$methodName()', ({ methodName }) => {
  ...
  ${0}        | ${0}        | ${0}    | ${T} | ${F} | ${F} | ${T} | ${F} | ${T}
  ${12345678} | ${12345678} | ${0}    | ${T} | ${F} | ${F} | ${T} | ${F} | ${T}
  ${-123.45}  | ${-123.45}  | ${0}    | ${T} | ${F} | ${F} | ${T} | ${F} | ${T}
  ${0}        | ${1}        | ${-1}   | ${F} | ${T} | ${F} | ${F} | ${T} | ${T}
  ${12.34}    | ${98765}    | ${-1}   | ${F} | ${T} | ${F} | ${F} | ${T} | ${T}
  ${100.9}    | ${100.9001} | ${-1}   | ${F} | ${T} | ${F} | ${F} | ${T} | ${T}
  ${1}        | ${0}        | ${1}    | ${F} | ${T} | ${T} | ${T} | ${F} | ${F}
  ${19}       | ${2}        | ${1}    | ${F} | ${T} | ${T} | ${T} | ${F} | ${F}
  ${9999.999} | ${9999.998} | ${1}    | ${F} | ${T} | ${T} | ${T} | ${F} | ${F}
...
`('$method()', ({ method, isStatic, returnsObject }) => {
  ...
  ${0}                | ${undefined}                      | ${'1970-01-01_00:00:00'}
  ${-14195365}        | ${undefined}                      | ${'1969-07-20_16:50:35'}
  ${1666016999.99999} | ${undefined}                      | ${'2022-10-17_14:29:59'}
  ${1673916141}       | ${undefined}                      | ${'2023-01-17_00:42:21'}
  ${1673916141.1234}  | ${undefined}                      | ${'2023-01-17_00:42:21'}
  ${1673916141.9}     | ${undefined}                      | ${'2023-01-17_00:42:21'}
  ${1673916141}       | ${{ middleUnderscore: false }}    | ${'2023-01-17 00:42:21'}
  ${1673916141}       | ${{ middleUnderscore: true }}     | ${'2023-01-17_00:42:21'}
  ${1673916141}       | ${{ decimals: 0 }}                | ${'2023-01-17_00:42:21'}
  ${1673916141.1234}  | ${{ decimals: 0 }}                | ${'2023-01-17_00:42:21'}
  ${1673916141.9}     | ${{ decimals: 0 }}                | ${'2023-01-17_00:42:21'}
  ${1673916141}       | ${{ decimals: 1 }}                | ${'2023-01-17_00:42:21.0'}
  ${1673916141.1234}  | ${{ decimals: 1 }}                | ${'2023-01-17_00:42:21.1'}
  ${1673916141.16}    | ${{ decimals: 1 }}                | ${'2023-01-17_00:42:21.1'}
  ${1673916141.97}    | ${{ decimals: 1 }}                | ${'2023-01-17_00:42:21.9'}
  ${1673916141}       | ${{ decimals: 4 }}                | ${'2023-01-17_00:42:21.0000'}
  ${1673916141.00008} | ${{ decimals: 4 }}                | ${'2023-01-17_00:42:21.0000'}
  ${1673916141.1234}  | ${{ decimals: 4 }}                | ${'2023-01-17_00:42:21.1234'}
  ${1673916141.12344} | ${{ decimals: 4 }}                | ${'2023-01-17_00:42:21.1234'}
  ${1673916141.12345} | ${{ decimals: 4 }}                | ${'2023-01-17_00:42:21.1234'}
  ${1673916141.12346} | ${{ decimals: 4 }}                | ${'2023-01-17_00:42:21.1234'}
  ${1673916141}       | ${{ colons: false }}              | ${'2023-01-17_004221'}
  ${1673916141.1234}  | ${{ colons: false }}              | ${'2023-01-17_004221'}
  ${1673916141.1234}  | ${{ colons: false, decimals: 1 }} | ${'2023-01-17_004221.1'}
  ${1673916141.1234}  | ${{ colons: false, decimals: 2 }} | ${'2023-01-17_004221.12'}
  ${1673916141}       | ${{ colons: true }}               | ${'2023-01-17_00:42:21'}
  ${1673916141.1234}  | ${{ colons: true }}               | ${'2023-01-17_00:42:21'}
  ${1673916141.1234}  | ${{ colons: true, decimals: 1 }}  | ${'2023-01-17_00:42:21.1'}
  ${1673916141.1234}  | ${{ colons: true, decimals: 2 }}  | ${'2023-01-17_00:42:21.12'}
  ${1673916141}       | ${{ dashes: false }}              | ${'20230117_00:42:21'}
  ${1673916141.1234}  | ${{ dashes: false }}              | ${'20230117_00:42:21'}
  ${1673916141.1234}  | ${{ dashes: false, decimals: 1 }} | ${'20230117_00:42:21.1'}
  ${1673916141.1234}  | ${{ dashes: false, decimals: 2 }} | ${'20230117_00:42:21.12'}
  ${1673916141}       | ${{ dashes: true }}               | ${'2023-01-17_00:42:21'}
  ${1673916141.1234}  | ${{ dashes: true }}               | ${'2023-01-17_00:42:21'}
  ${1673916141.1234}  | ${{ dashes: true, decimals: 1 }}  | ${'2023-01-17_00:42:21.1'}
  ${1673916141.1234}  | ${{ dashes: true, decimals: 2 }}  | ${'2023-01-17_00:42:21.12'}
