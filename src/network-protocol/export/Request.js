...
export class Request {
   ...
   * generated by default. The response headers always get set to make the
   * response _not_ be cacheable. This method is intended to be used for all
   * "meta-ish" non-content responses, such as not-founds, redirects, etc., so
   * as to provide a standard form of response (though with some flexibility).
   *
