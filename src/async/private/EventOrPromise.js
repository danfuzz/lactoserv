...
export class EventOrPromise {
   ...
   * @param {?function(new:LinkedEvent)} [subclass] Subclass which `event` (or
   *   the resolved promise for it) must be an instance of, or `null` not to
   *   require a specific subclass.
   */
